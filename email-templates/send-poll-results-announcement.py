#!/usr/bin/env python3
"""
Send poll results announcement email via Gmail API
...
HTML_FILE = "poll-results-announcement.html"
...
def main():
    ...
    print(f"📧 Sending poll results announcement email...")
    ...
    if success:
        print()
        print("🎉 Email sent successfully to all Social Committee members!")
        print()
        print("Recipients:")
        print(f"  To: {TO_EMAIL}")
        for cc in CC_EMAILS:
